...
def create_lib():
   books = {
       ...
       'The Wings of Fire':'Free',
       'Highway Engieering':'Free',
       'DO It Today':'Free',
       'Deep Work':'Free',
       'Somtyhing I Never Told You':'Free',
       'TheHabit of Winning':'Free',
       'Death an Inside Story':'Free', 
       'Rework':'Free',
       'You Can':'Free':
       'The Power of Habit':'Free',
       'Can\'t Hurt Me':'Free,
       'The Alchemist':'Free',
       'Your a Badass':'Free',
       'Miracal Morning':'Free',
       'The Magic':'Free',
}
